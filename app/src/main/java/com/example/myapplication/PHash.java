 ...
 * Obtained From: https://gist.github.com/kuFEAR/6e20342198d4040e0bb5
 */
public class PHash {
    ...
    public long getHash(Drawable img) {
        return getHash(getBitmap(img));
    }

    public long getHash(Bitmap img) {
